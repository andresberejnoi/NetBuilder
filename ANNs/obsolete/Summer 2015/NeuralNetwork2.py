...
class Neuron(object):
    ...
    def __init__(self):
        ...
        self.index = 0
        self.layer_pos = 0
        self._derivativeLinearOut = None                                     #The derivative of the linear function. It is just a constant
    ...
    def output_prime(self):
        self._derivativeLinearOut = self.input*(1-self.input)
       # return self._derivativeLinearOut

    def outputActivation(self):
        '''Computes the output of the neuron using a linear sum of weights times the inputs.'''
